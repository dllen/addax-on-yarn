package com.github.dllen;

import com.github.dllen.addax.AddaxManagerHttpServer;
import com.github.dllen.utils.Log4jPropertyHelper;
...
public class ApplicationMaster {
    ...
    private final ConcurrentHashMap<ContainerId, Container> runningContainers = new ConcurrentHashMap<>();

    private AddaxManagerHttpServer httpServer;
    ...
    public boolean init(String[] args) throws ParseException, IOException {
        ...
        if (fileExist(LOG_4_J_PATH)) {
            try {
                Log4jPropertyHelper.updateLog4jConfiguration(ApplicationMaster.class, LOG_4_J_PATH);
            } catch (Exception e) {
    ...
    public void run() throws YarnException, IOException {
        ...
        if (containerMemory + memoryOverhead > maxMem) {
            LOG.info("Container memory specified above max threshold of cluster." + " Using max value." + ", specified=" + (containerMemory + memoryOverhead) + ", max=" + maxMem);
