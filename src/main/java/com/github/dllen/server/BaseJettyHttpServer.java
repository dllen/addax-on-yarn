package com.github.dllen.server;
 ...
 * BaseHttpServer
 */
public abstract class BaseJettyHttpServer implements Closeable {

    private static final Log LOG = LogFactory.getLog(BaseJettyHttpServer.class);
